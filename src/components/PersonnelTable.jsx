      ...
      <div className=" overflow-x-auto pb-4">
        <div className="min-w-full inline-block align-middle">
          <div className="overflow-hidden  border rounded-lg border-gray-300">
            <table className="table-auto rounded-xl w-full">
              <thead className="bg-primary">
                <tr className="">
                  <th
                    scope="col"
                    className="p-5 text-left whitespace-nowrap text-sm leading-6 font-semibold text-light capitalize"
                  >
                    {" "}
                    Nom et Prénom{" "}
                  </th>
              ...
              <tbody className="divide-y divide-gray-300">
                <tr className="bg-white transition-all duration-500 hover:bg-gray-50">
                  <td className="p-5 whitespace-nowrap border text-sm leading-6 font-medium text-gray-900 ">
                    <div className="w-48 flex items-center gap-3">
                      <Image
                        src="https://res.cloudinary.com/djcnq7nmj/image/upload/v1730411682/profile_qjehzj.png"
                        alt="Floyd image"
                        className="w-10 h-10"
                        width={100}
                        height={100}
                  ...
                  <td className="py-3 px-3">{personnel.cin}</td>
                  <td className="p-5 uppercase whitespace-nowrap border text-sm leading-6 font-medium text-gray-900">
                    {" "}
                    {personnel.grade}
                  </td>
                  <td className="p-5 whitespace-nowrap border text-sm leading-6 font-medium text-gray-900">
